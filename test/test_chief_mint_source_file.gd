...
func test_is_complete_true_when_progress_reaches_maximum():
	...
	assert_true(
		source.is_complete("Second Achievement"), "Should be complete when progress reaches maximum"
	)
...
func test_is_complete_true_when_progress_exceeds_maximum():
	...
	assert_true(
		source.is_complete("Second Achievement"), "Should be complete when progress exceeds maximum"
	)
...
func test_completion_achievement_auto_completes():
	...
	assert_true(
		source.is_complete("Completion Achievement"),
...
func test_completion_achievement_does_not_complete_prematurely():
	...
	assert_false(
		source.is_complete("Second Achievement"), "Second achievement should not be complete"
	)
...
func test_completion_achievement_signal_emits_only_once():
	...
	assert_signal_emit_count(
		source, "completion_achievement_unlocked", 1, "Should emit signal exactly once"
	)
