...
const MINT_SOURCE_SETTING := "chief_mint/source/source_script"
const MINT_SOURCE_DEFAULT := "res://addons/chief_mint/sources/chief_mint_source_file.gd"

const MINT_SOURCE_LOCAL_PATH_SETTING := "chief_mint/source/local_source_location"
const MINT_SOURCE_LOCAL_PATH_DEFAULT := "user://chiefmints.info"
